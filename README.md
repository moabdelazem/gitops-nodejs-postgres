...
| Pipeline job (`Jenkinsfile`) to build and push Docker image                | Done    | [`Jenkinsfile`](Jenkinsfile)                                                                                                                                            |
...
| Helm manifests for Kubernetes deployment (HA, persistence, public service) | Done    | [`charts/gitops-nodejs-postgres/Chart.yaml`](charts/gitops-nodejs-postgres/Chart.yaml), [`charts/gitops-nodejs-postgres/values.yaml`](charts/gitops-nodejs-postgres/values.yaml), [`charts/gitops-nodejs-postgres/templates/deployment.yaml`](charts/gitops-nodejs-postgres/templates/deployment.yaml), [`charts/gitops-nodejs-postgres/templates/service.yaml`](charts/gitops-nodejs-postgres/templates/service.yaml), [`charts/gitops-nodejs-postgres/templates/ingress.yaml`](charts/gitops-nodejs-postgres/templates/ingress.yaml), [`charts/gitops-nodejs-postgres/templates/postgres-statefulset.yaml`](charts/gitops-nodejs-postgres/templates/postgres-statefulset.yaml) |
| Autoscaling manifest for replicas                                          | Done    | [`charts/gitops-nodejs-postgres/templates/hpa.yaml`](charts/gitops-nodejs-postgres/templates/hpa.yaml), [`charts/gitops-nodejs-postgres/values.yaml`](charts/gitops-nodejs-postgres/values.yaml) |
| Argo CD app pointing to Helm manifests                                     | Done    | [`application.yml`](application.yml)                                                                                                                                   |
| Manage Kubernetes secrets using Sealed Secrets                             | Done    | [`charts/gitops-nodejs-postgres/templates/sealedsecret.yaml`](charts/gitops-nodejs-postgres/templates/sealedsecret.yaml), [`application.yml`](application.yml), [`charts/gitops-nodejs-postgres/values.yaml`](charts/gitops-nodejs-postgres/values.yaml) |
